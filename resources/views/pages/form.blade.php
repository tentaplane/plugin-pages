                                ...
                                <div class="tp-field">
                                    ...
                                    @else
                                        <input
                                            ...
                                            placeholder="default" />
                                        <div class="tp-help">
                                            No theme layouts found{{ ! empty($hasTheme) ? '' : ' (no active theme)' }}
                                            — using free text key.
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="tp-panel space-y-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <template x-for="(block, index) in blocks" :key="block._key">
                                        <div class="tp-metabox bg-zinc-50">
                                            <div
                                                ...
                                                <template x-if="fieldsFor(block.type).length > 0">
                                                    <div class="space-y-4">
                                                        <template
                                                            ...
                                                            :key="field.key">
                                                            <div class="tp-field">
                                                                <label class="tp-label" x-text="field.label"></label>
                                                                ...
                                                                <template x-if="field.type === 'media'">
                                                                    <div class="space-y-3">
                                                                        ...
                                                                        <div class="space-y-1">
                                                                            ...
                                                                            <div class="tp-help">Pick from media or paste a URL.</div>
                                                                        </div>

                                                                        <div class="tp-muted text-xs" x-show="mediaOptions.length === 0">
                                                                    ...
                                                                    <div class="space-y-3">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <template
                                                                                ...
                                                                                :key="url + ':' + mediaIdx">
                                                                                <div class="space-y-2 rounded border border-black/10 bg-white p-2">
                                                                                    <div
                                                                        ...
                                                                        <div class="space-y-1">
                                                                            ...
                                                                            <div class="tp-help">One URL per line for advanced edits.</div>
                                                                        </div>
                                                                ...
                                                                <template x-if="field.help">
                                                                    <div class="tp-help" x-text="field.help"></div>
                                                                </template>
                                                            </div>
                                                        </template>
                                                    </div>
...
{{ $initialBlocksJson }}
                                ...
                                <div
                                    ...
                                    <div class="flex max-h-[85vh] w-full max-w-6xl flex-col overflow-hidden rounded-lg border border-black/10 bg-white shadow-xl">
                                        <div class="flex flex-wrap items-center gap-2 border-b border-black/10 px-4 py-3">
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <div class="tp-muted text-xs" x-show="mediaModalMode === 'multi'">
                                            ...
                                            <div class="flex w-full gap-2 sm:w-auto">
                                                ...
                                                <button type="button" class="tp-button-secondary" @click="closeMediaModal()">
                                                    Close
                                                </button>
                                            </div>
                                        </div>
                                                    ...
                                                    <button
                                                        ...
                                                        <div
                                                            ...
                                                            <img
                                                                ...
                                                                alt=""
                                                                class="h-full w-full object-cover" />
                                                            <div x-show="!opt.is_image" class="tp-muted text-xs uppercase">
                                                                File
                                                            </div>
                                                        </div>
                                                        <div class="min-w-0">
                                        ...
                                        <div
                                            ...
                                            <div class="tp-muted text-xs">
                                                <span class="font-semibold" x-text="modalSelectionCount()"></span>
                                                selected
                                            </div>
                                            <div class="flex items-center gap-2">
                                                <button type="button" class="tp-button-secondary" @click="modalClearSelection()">
                                                    Clear
                                                </button>
                                                <button type="button" class="tp-button-primary" @click="modalApplyMulti()">
                                                    Use selected
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <script>
                                document.addEventListener('alpine:init', () => {
                                    Alpine.data('tpBlocksEditor', (opts) => ({
                                        ...
                                        mediaIndexUrl: typeof opts.mediaIndexUrl === 'string' ? opts.mediaIndexUrl : '',
                                        addType: '',
                                        blocks: [],
                                        jsonInvalid: false,
                                        ...
                                        mediaOption(value) {
                                            ...
                                            if (!key) return null;
                                            const found =
                                                this.mediaOptions.find((opt) => opt && String(opt.value) === key) || null;
                                            if (found) {
                                                return found;
                                            }
                                            return {
                                        ...
                                        openMediaModal(index, key, mode = 'single') {
                                            ...
                                            if (this.mediaModalMode === 'multi' && this.mediaModalIndex !== null) {
                                                const existing = this.getMediaList(this.mediaModalIndex, this.mediaModalKey);
                                                const selection = {};
                                        ...
                                        modalFilteredOptions() {
                                            ...
                                            return this.mediaOptions.filter((opt) => opt && this.modalMatches(opt, query));
                                        },
